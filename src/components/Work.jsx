...
import Areascouts from '../assets/areascouts.png';
...
import MirconetBD from '../assets/micronetbd.png';

const Work = () => {
return (
<div name='work' className='w-full bg-[#0a192f] text-gray-300 py-36'>
  <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
    ...
    <div style={{ backgroundImage: `url(${MirconetBD})` }}
        ...
        <div className='opacity-0 group-hover:opacity-100'>
          ...
          <div className='pt-8 text-center'>
            <a href='https://micronetbd.org/' target='_blank'>
      ...
      <div style={{ backgroundImage: `url(${Areascouts})` }}
        ...
        <div className='opacity-0 group-hover:opacity-100'>
          ...
          <div className='pt-8 text-center'>
            <a href='https://www.basemission.com/' target='_blank'>
              <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                Demo
              </button>
            </a>
      ...
      <div style={{ backgroundImage: `url(${BM})` }}
        className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'>
        {/* Hover Effects */}
        <div className='opacity-0 group-hover:opacity-100'>
          <span className='text-2xl font-bold text-white tracking-wider'>
